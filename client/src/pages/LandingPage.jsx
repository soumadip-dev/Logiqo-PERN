        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            {authUser ? (
              ...
              >
                <img
                  src={authUser.image || 'https://avatar.iran.liara.run/public/8'}
                  alt="Profile"
                  className="w-10 h-10 rounded-full object-cover border-2 border-violet-500/50 shadow-lg shadow-violet-500/25"
                  onError={e => {
                    // Fallback if image fails to load
                    e.target.style.display = 'none';
                    e.target.parentElement.innerHTML = `
            <div class="w-10 h-10 rounded-full bg-gradient-to-r from-violet-500 to-blue-500 flex items-center justify-center text-white text-sm font-semibold shadow-lg shadow-violet-500/25">
